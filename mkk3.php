    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><a href="mkk3.php" class="nav-link px-2 text-white ">Home</a></li>
        ...
        <div class="text-end">
          <a href="login_user.php"><button type="button" class="btn btn-outline-light me-2">Login</button></a>
          <a href="mkkdaftar.php"><button type="button" class="btn btn-warning ">Sign-up</button></a>
        </div>
      </div>
    </div>
  </header>
  ...
  <div class="row gap-4 m-3">
    ...
    <!-- <div class="item" style="border: 2px solid #fff"> -->   
      <div class="card" style="width: 18rem;">
        <form method="post" action="cart_view.php?id=<?=$row['id']?>">
      ...
      <div class="card-body">
        ...
        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
          content.</p>
          <a href="login_user.php" class="btn btn-primary">Buy</a>
          <input type="number" name="quantity" class="form-control" value="1">
          <input type="hidden" name="hidden_name" value="<?=$data['nama_kue']?>">
          <input type="hidden" name="quantity" value="<?=$data['harga_kue']?>">
